class Solution:
    def longestIncreasingPath(self, matrix: List[List[int]]) -> int:
        ...
        # - visited set not needed since the nature of the problem
        # which imposes a strictly increasing sequence eliminates cycles
        ...
        def dfs(row, col):
            ...
            dp[(row, col)] = res + 1
            return dp[(row, col)]
        # memoization eliminates repeated work, but cannot
        # reduce the necessary recursion depth of the first
        # unresolved path
        res = 0
