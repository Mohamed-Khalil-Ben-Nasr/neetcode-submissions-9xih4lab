class Solution:
    def generateParenthesis(self, n: int) -> List[str]:
        ...
        def dfs(o, combo, stack):
            ...
            # resetting state after visiting each branch in the decision
            # tree is important, because this is not a simple include/exclude
            # cuz in both branches we add an element
